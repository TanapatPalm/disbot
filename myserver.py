...
# ⚙️ Database Config (ต้องใส่ในนี้ด้วยเพื่อให้เว็บดึงข้อมูลได้)
...
<head>
    ...
    <style>
        ...
        .event-title { font-weight: bold; font-size: 18px; margin-bottom: 4px; }
        .event-time { font-size: 14px; color: #e0e0e0; }
    </style>
</head>
<body>
<div class="container">
...
def server_on():
    t = Thread(target=run)
    t.daemon = True # ทำให้ปิด Thread อัตโนมัติเมื่อปิดบอท
    t.start()
